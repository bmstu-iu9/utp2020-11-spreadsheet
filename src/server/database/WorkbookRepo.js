...
export default class WorkbookRepo {
  ...
  getById(id) {
    try {
      ...
      throw DatabaseError(`Error while get book: no book with id ${id}`);
    } catch (err) {
      throw DatabaseError(`Error while get workbook: ${err}`);
    }
  }
  ...
  getByLogin(login) {
    try {
      ...
      throw DatabaseError(`Error while get books: no books with login ${login}`);
    } catch (err) {
      throw DatabaseError(`Error while get workbooks: ${err}`);
    }
  }
  ...
  save(book) {
    if (book.id == null) {
      try {
        ...
        throw DatabaseError(`Error while inserting book: ${e}`);
      }
    } else {
      try {
        ...
        throw DatabaseError(`Error while updating book: ${e}`);
      }
    }
  }
  ...
  delete(id) {
    try {
      ...
      throw DatabaseError(`Error while deleting book: ${err}`);
    }
  }
  ...
  deleteAll() {
    try {
      ...
      throw DatabaseError(`Error while deleting books: ${e}`);
    }
  }
}
